package com.highcoldcoder.blackblacksmalljiji.imdemo.im4.client;

import com.highcoldcoder.blackblacksmalljiji.imdemo.im4.client.eventListener.CloseListener;
import com.highcoldcoder.blackblacksmalljiji.imdemo.im4.client.eventListener.SendListener;
import com.highcoldcoder.blackblacksmalljiji.imdemo.im4.client.eventListener.StartListener;
 ...
 * IM通讯日记-2
 */
public class ClientSocketExample4 extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ClientSocketExample4 frame = new ClientSocketExample4();
